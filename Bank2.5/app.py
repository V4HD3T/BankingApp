...
def kredi_odemesi(anapara, faiz_orani, aylik_sayisi):
    aylik_faiz_orani = Decimal(faiz_orani) / 100
    ...
    aylik_odeme = aylik_odeme.quantize(Decimal('0.01'), rounding=ROUND_UP)
    toplam_odeme = toplam_odeme.quantize(Decimal('0.01'), rounding=ROUND_UP)
...
def index():
    ...
    if request.method == 'POST':
        ...
        if anapara < secili_tur['min_tutar'] or anapara > secili_tur['max_tutar']:
            ...
            aylik_odeme, toplam_odeme = kredi_odemesi(Decimal(anapara), secili_tur["kar_orani"], aylik_sayisi)
            ...
            return render_template('index.html', finansman_turleri=finansman_turleri, sonuc=True,
                                   ...
                                   aylik_odeme=aylik_odeme, toplam_odeme=toplam_odeme, uyarı=uyarı, hata_mesaji=hata_mesaji, secili_tur_no=secili_tur_no)
