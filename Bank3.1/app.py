...
def index():
    ...
    if request.method == 'POST':
        ...
        if anapara < secili_tur["min_tutar"] or anapara > secili_tur["max_tutar"]:
            hata_mesaji = f"Finansman tutarı {secili_tur['min_tutar']} TL ile {secili_tur['max_tutar']} TL arasında olmalıdır."
    ...
    return render_template('index.html', finansman_turleri=finansman_turleri, sonuc=False, hata_mesaji=hata_mesaji, secili_tur_no=None)
